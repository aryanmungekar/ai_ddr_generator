...
API_KEY = "AIzaSyACNNKiqovxMa6v5Jgx114MfkbMDuGe-g4"
...
# PROMPT
# =========================
def generate_prompt(inspection_text, thermal_text):
    return f"""
...
def index():
    ...
    try:
        ...
        data = json.loads(safe_extract_text(res))
